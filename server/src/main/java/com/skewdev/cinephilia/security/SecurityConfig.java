...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// Authenticated
		http.authorizeRequests().antMatchers(HttpMethod.POST, "/movies").permitAll();
		http.authorizeRequests().antMatchers(HttpMethod.POST, "/movies/{movieId}/reviews").permitAll();

		// Moderator
		http.authorizeRequests().antMatchers(HttpMethod.PUT, "/movies").permitAll();
		http.authorizeRequests().antMatchers(HttpMethod.DELETE, "/movies/{movieId}").permitAll();
